...
touch /etc/nginx/sites-available/0.0.0.0
tee /etc/nginx/sites-available/0.0.0.0 << EOF
server {
    listen 80;
...
ln -s /etc/nginx/sites-available/0.0.0.0 /etc/nginx/sites-enabled/0.0.0.0
